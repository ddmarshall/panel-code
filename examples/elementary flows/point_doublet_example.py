...
def draw_point_doublet_flow_field():
    ...
    source = PointDoublet2D(x0=1, y0=2, strength=1.0, angle=np.pi/2)
    ...
    ax.contour(xg, yg, stream_function, levels=60, colors="blue",
               linestyles="solid")
    ax = potential_axis
    ax.contour(xg, yg, potential, levels=60, colors="blue",
               linestyles="solid")
    ax = velocity_axis
